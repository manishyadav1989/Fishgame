...
(function() {
    ...
    function b(b, s) {
        ...
        function w(a) {
            a = r(a);
            if (a !== void 0)
                if (a.event === "pusher:connection_established") d._machine.transition("connected", a.data.socket_id);
    ...
    b.prototype.connect = function() {
        !this._machine.is("failed") &&
            !a.Transport ? this._machine.transition("failed") : this._machine.is("initialized") ? (c(this), this._machine.transition("waiting")) : this._machine.is("waiting") && this.netInfo.isOnLine() === !0 ? this._machine.transition("connecting") : this._machine.is("permanentlyClosed") && (c(this), this._machine.transition("waiting"))
    };
...
(function() {
    ...
    c.prototype = {
        ...
        get: function(b) {
            return this._members_map.hasOwnProperty(b) ? {
                id: b,
                info: this._members_map[b]
            } : null
        }
    };
...
(function() {
    ...
    Pusher.authorizers = {
        ajax: function(c, b) {
            var a;
            // console.log(Pusher.channel_auth_endpoint)
